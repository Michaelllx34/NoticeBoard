...
<head>
    ...
    <title>회원가입</title>
    <script defer src="./js/regist.js"></script>		<!-- js파일 필요 -->
...
<body>
    <h2>회원가입</h2>
    <!-- post 방식일 때는 가입완료를 눌렀을 때 입력 내용이 안보임 -->
    <!-- 아무것도 안쓰고 넘겨지는것 방지 -> onsubmit="false": 안넘어감, "true": 넘어감 -->
    <form action="./MemberOk" name="regform" id="regform" method="post" onsubmit="return sendit()">		<!-- jsp: "./05_member_ok.jsp"	/	servlet:"./MemberOk" -->
    ...
    <p>이미 회원이신가요?<a href="01_login.jsp">로그인</a></p>
</body>
</html>