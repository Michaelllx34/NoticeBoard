...
<body>
    <h2>정보수정</h2>
    <form action="./InfoOk" name="regform" id="regform" method="post" onsubmit="return sendit()">		<!-- jsp: "./07_info_ok.jsp"	/	servlet:"./InfoOk" -->
        <p>아이디: <%=userid %></p>
        ...
        <p><button>수정완료</button> <button type="reset">다시작성</button> <button type="button" onclick="location.href='01_login.jsp'">돌아가기</button></p>
    </form>
</body>
</html>
